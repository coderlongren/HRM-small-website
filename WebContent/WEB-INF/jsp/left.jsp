...
<body>
	<div style="margin:10px;background-color:#FFFFFF; text-align:left;">
		<table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
		 ...
		 <tr><td height="2"></td></tr>
		   <tr><td id="navbg4" class="left_nav_closed" ><div class="font1">工作管理</div></td></tr>
		  <tr valign="top" id="submenu4" style="display: none">
		    <td class="left_nav_bgshw" height="50">
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/work_info/selectWork_info" target="main">上班记录</a></img></p>
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/work_info/salary_info" target="main">薪资管理</a></img></p>
			</td>
		  </tr>
		  ...
		  <tr valign="top"><td height="100%" align="center"></tr>
