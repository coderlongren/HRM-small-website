...
public class UserController {
	...
	@RequestMapping(value="/user/selectUser")
	 public String selectUser(Model model,Integer pageIndex,
			 @ModelAttribute User user){
		System.out.println(" 我在 selectUser方法内，，，，，user = " + user);
	...
	@RequestMapping(value="/user/updateUser1")
	 public String  updateUser1(User user,String flag){
